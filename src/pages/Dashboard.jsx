...
import { Cloud, Sunrise, Leaf, DollarSign, Droplets, Video, PhoneCall } from 'lucide-react';
...
const priceData = [
  ...
  { name: 'Rice', price: 1940 },
  { name: 'Maize', price: 1962 },
  { name: 'Cotton', price: 6080 },
];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard title={t.weatherCondition} value="28°C / Clear" icon={<Sunrise className="text-amber-500" />} change={t.optimal} />
        <MetricCard title={t.recommendedCrop} value="Wheat" icon={<Leaf className="text-primary" />} change={t.highYield} />
        <MetricCard title={t.expectedYield} value="7.2 Tons" icon={<Cloud className="text-blue-500" />} change="+12% from last year" />
        <MetricCard title={t.estimatedProfit} value="₹1.4 Lakhs" icon={<DollarSign className="text-green-600" />} change="+8% market trend" />
      </div>
          ...
          <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-md flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="p-2 bg-blue-100 dark:bg-gray-800 rounded-xl">
      ...
      {/* Video + Advisory Section */}
      <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-md mt-6">
...
const MetricCard = ({ title, value, icon, change }) => (
  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-all flex flex-col justify-between group">
    ...
    <div className="text-xs font-medium text-gray-500 dark:text-gray-400 px-3 py-1 bg-gray-100 dark:bg-gray-800 inline-block rounded-full self-start">
      {change}
    </div>
  </div>
);
