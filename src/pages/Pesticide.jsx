            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-destructive/10 rounded-2xl p-5 border border-destructive/20 flex space-x-3 items-start shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-destructive text-sm mb-1">{t.safetyInst || "Safety Instructions"}</h4>
                    <p className="text-sm text-destructive/90 leading-relaxed font-medium">{result.safety}</p>
                  </div>
                </div>
              </div>
            </motion.div>
